    ...
    stage('Create tar and CSV of all output') {
      steps {
        script {
          ...
          sh "/opt/rh/rh-python36/root/bin/python3 pipeline_csv_gen.py output/${ROOT_FOR_REPO_IMAGE}/${SPECIFIC_FOLDER_FOR_RUN}/${S3_OSCAP_CVE_REPORT} output/${ROOT_FOR_REPO_IMAGE}/${SPECIFIC_FOLDER_FOR_RUN}/${S3_OSCAP_REPORT} output/${ROOT_FOR_REPO_IMAGE}/${SPECIFIC_FOLDER_FOR_RUN}/{S3_TWISTLOCK_REPORT} output/${ROOT_FOR_REPO_IMAGE}/${SPECIFIC_FOLDER_FOR_RUN}/${S3_ANCHORE_SECURITY_REPORT} output/${ROOT_FOR_REPO_IMAGE}/${SPECIFIC_FOLDER_FOR_RUN}/${S3_ANCHORE_GATES_REPORT}"
