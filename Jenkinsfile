    ...
    stage('Python Things') {
      steps {
        script {
          ...
          echo "sh /opt/rh/rh-python36/root/bin/python3 output/pipeline_csv_gen.py output/${ROOT_FOR_REPO_IMAGE}/${S3_OSCAP_CVE_REPORT} output/${ROOT_FOR_REPO_IMAGE}/${S3_OSCAP_REPORT} output/${ROOT_FOR_REPO_IMAGE}/{S3_TWISTLOCK_REPORT} output/${ROOT_FOR_REPO_IMAGE}/${S3_ANCHORE_SECURITY_REPORT} output/${ROOT_FOR_REPO_IMAGE}/${S3_ANCHORE_GATES_REPORT} ${S3_CSV_LOCATION}"

          sh "/opt/rh/rh-python36/root/bin/python3 output/pipeline_csv_gen.py output/${ROOT_FOR_REPO_IMAGE}/${S3_OSCAP_CVE_REPORT} output/${ROOT_FOR_REPO_IMAGE}/${S3_OSCAP_REPORT} output/${ROOT_FOR_REPO_IMAGE}/{S3_TWISTLOCK_REPORT} output/${ROOT_FOR_REPO_IMAGE}/${S3_ANCHORE_SECURITY_REPORT} output/${ROOT_FOR_REPO_IMAGE}/${S3_ANCHORE_GATES_REPORT} ${S3_CSV_LOCATION}"
